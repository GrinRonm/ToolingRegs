<div class="text-columns">
    <div class="text-column">
        ...
        <div style="margin-top:20px;">
            <label>Пароль для PDF</label>
            <input type="password" id="pdf-password" class="form-control" placeholder="Введите пароль...">
        </div>

        <div class="btn-group" id="action-buttons" style="display:none; margin-top:16px;">
            <button class="btn btn-primary" id="btn-process" style="flex:1;">🔒 Зашифровать</button>
        ...
        <div class="progress-wrap" id="progress-wrap" style="margin-top:16px;">
            ...
            <div class="progress-text" id="progress-text">Шифрование...</div>
        </div>
    </div>
