...
$pythonScript = realpath(__DIR__ . '/../../../python/pdf2excel.py');
...
if (!$result || !isset($result['success'])) {
    return ['error' => 'Ошибка при извлечении таблиц: ' . ($result['error'] ?? 'Неизвестная ошибка')];
}
...
return [
    'success' => true,
    'download_url' => '/api/download?id=' . $filename . '&name=' . urlencode($originalName . '.xlsx'),
